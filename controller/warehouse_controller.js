...
exports.getAllWarehouses = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Warehouses retrieved successfully', data: warehouses });
    } catch (error) {
...
exports.addWarehouse = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: 'Warehouse added successfully', data: savedWarehouse });
    } catch (error) {
...
exports.editWarehouse = async (req, res) => {
    try {
        ...
        const updatedWarehouse = await Warehouse.findByIdAndUpdate(warehouseId, updatedData, {
...
exports.deleteWarehouse = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Warehouse deleted successfully', data: deletedWarehouse });
    } catch (error) {
