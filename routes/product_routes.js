...
router.get("/get/productsFilterwarehouseId/:categoryName/:warehouseId", ProductController.getProductsByWarehuseCategorySubCategory);
router.get("/get/productsFilterwarehouseName/:categoryName/:warehouseName", ProductController.getProductsByWarehuseCategorySubCategory);
...
router.get("/get/draft/productsFilterwarehouseId/:categoryName/:warehouseId", ProductController.getDraftProductsByWarehuseCategorySubCategory);
router.get("/get/lowStock/productsFilterwarehouseId/:categoryName/:warehouseId", ProductController.getLowStockProductsByWarehuseCategorySubCategory);
